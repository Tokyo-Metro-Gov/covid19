...
| 本番 | master | http://iwate.stopcovid19.jp/ ( 暫定運用中 https://covid19-iwate.netlify.com/ ) | 管理者以外の Pull Request は禁止です |

#### システムで利用しているブランチ
| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 本番サイトHTML | production | http://iwate.stopcovid19.jp/ ( 暫定運用中 https://covid19-iwate.netlify.com/ ) | 静的ビルドされたHTMLが置いてある場所 |
