        ...
        <template v-slot:additionalDescription>
          ...
          <ul>
            <li>
              {{
                $t(
                  '曜日などによる数値のばらつきにより、日々の結果が変動するため、こうしたばらつきを平準化し全体の傾向を見る趣旨から、過去７日間の移動平均値を折れ線グラフで示す（例えば、11月16日の移動平均値は、11月10日から11月16日までの実績値を平均したもの）'
                )
              }}
            </li>
            <li>
              {{ $t('東京都発熱相談センターを開設した10月30日17時から作成') }}
            </li>
          </ul>
        </template>
      </fever-mixed-chart>
