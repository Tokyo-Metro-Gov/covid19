  ...
  methods: {
    ...
    customSort(items, index, isDesc) {
      ...
      items.sort((a, b) => {
          ...
          index[0] === '年代'
            ? (a[index[0]] === lt10 || b[index[0]] === lt10) &&
              ...
              : (a[index[0]] === lt100 || b[index[0]] === lt100) &&
                a[index[0]] === lt100
              ? 1
              : String(a[index[0]]) < String(b[index[0]])
              ? -1
              : 1
            : 0
        ...
        comparison =
          a[index[0]] === investigating || b[index[0]] === investigating
        ...
        comparison =
          a[index[0]] === unknown || b[index[0]] === unknown
            ? a[index[0]] === unknown
              ? 1
              : -1
            : comparison

        return isDesc[0] ? -comparison : comparison
      })
      return items
    }
  }
