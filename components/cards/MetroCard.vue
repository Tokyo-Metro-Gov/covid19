...
<i18n>
{
  ...
  "vi": {
    "都営地下鉄の利用者数の推移": "Số lượng hành khách tàu điện ngầm Toei",
    "期間: {duration}": "Thời gian: {duration}",
    "{duration}の利用者数との相対値: {percentage}": "Giá trị tương đối dựa trên số lượng người dùng {duration}: {percentage}",
    "1月20日~1月24日": "20~24/1",
    "2月10日~14日": "10~14/2",
    "2月17日~21日": "17~21/2",
    "2月25日~28日": "25~28/2"
