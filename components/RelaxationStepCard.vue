    ...
    <div class="RelaxationStep-content">
      <div class="RelaxationStep-block RelaxationStep-block-description">
        <p>
          {{
            $t(
              '休業要請緩和のステップについては、令和2年5月22日時点の状況を「ステップ0」とし、施設の特性やクラスター発生歴等から判断して、「ステップ3」までの4段階を設定し、段階的に施設の休業要請を緩和してきましたが、6月18日（木）をもって、全ての施設の休業要請を終了しました。'
            )
          }}
        </p>
        <p>
          {{
            $t(
              '※イベントの開催に当たっては、引き続き規模に応じた制限があります。'
            )
          }}
        </p>
      </div>
...
.RelaxationStep-block-description {
  p {
    margin: 0;
  }
}
