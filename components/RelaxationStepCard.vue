    ...
    <div class="RelaxationStep-content">
      <div class="RelaxationStep-block RelaxationStep-block-description">
        <p>
          {{
            $t(
              '休業要請緩和のステップについては、令和2年5月22日時点の状況を「ステップ0」とし、施設の特性やクラスター発生歴等から判断して、「ステップ3」までの4段階を設定し、段階的に施設の休業要請を緩和してきましたが、6月11日（木）をもって、ほぼ全ての施設の休業要請を終了しました。'
            )
          }}
          <br />
          {{
            $t(
              'なお、接待を伴う飲食店等及びライブハウスについては、6月18日（木）をもって、休業要請を終了します。'
            )
          }}
        </p>
      </div>
