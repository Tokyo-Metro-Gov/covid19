...
"en": {
  ...
  "ja-basic": {
    "不安に思う方": "不安（ふあん）、心配（しんぱい）な 人（ひと）",
    "微熱": "少（すこ）し 熱（ねつ）が ある 人（ひと）",
    "軽い咳": "少（すこ）し 咳（せき）を している 人（ひと）",
    "感染の不安": "コロナウイルスに かかる 不安（ふあん）、心配（しんぱい）",
    "新型コロナコールセンター": "新（あたら）しい コロナコールセンター（コロナウイルスの 病気（びょうき）について 電話（でんわ）相談（そうだん）できるところ）",
    "午前9時から午後9時（土日祝含む）": "午前（ごぜん）9時（じ）から 夜（よる）の 午後（ごご）9時（じ）まで （土曜日（どようび）、日曜日（にちようび）、休（やす）み の 日（ひ）も やっています）",
