...
<i18n>
{
  ...
  "en": {
    ...
    "{advisory}による相談結果": "After your inquiry to {advisory}",
    "新型コロナ受診相談窓口": "advisory",
...
>>>>>>> Fix components/flow/FlowPc.vue (ja-basic)
