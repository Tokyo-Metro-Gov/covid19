...
<<<<<<< HEAD
    ...
    "検査の必要あり": "あなたは けんさ をうけてください といわれています",
    "検査の必要なし": "あなたは けんさを うけなくてよい と いわれています"
=======
    "新型コロナ外来（帰国者・接触者外来）": "新（あたら）しい コロナウイルス に 対応（たいおう）する 病院 （帰国者・接触者外来（きこくしゃ・せっしょくしゃ がいらい）",
    "医師による判断": "医者（いしゃ）による 判断（はんだん）",
    "検査の必要あり": "検査（けんさ）の 必要（ひつよう）あり",
    "検査の必要なし": "検査（けんさ）の 必要（ひつよう）なし"
>>>>>>> [i18n] fix components/flow Required
  }
}
</i18n>
>>>>>>> [i18n] FlowPcRequired.vue の文言を更新
