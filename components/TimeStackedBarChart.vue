...
<i18n>
 {
   ...
   "zh-cn": {
     ...
     "検査実施数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "检查数是快讯方式公开的数值，日后有可能变更",
     "{date}の全体累計": "截至 %{date}",
    "{date}の合計": "%{date}当日合计",
     "都内": "东京都",
     "その他": "其它",
   ...
   "ko": {
     ...
     "検査実施数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "검사실시수는 속보치이며 차후 확정데이터로 수정될수있습니다",
   ...
   "ja-basic": {
     ...
     "検査実施数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "検査（けんさ）した数（かず）は、急（いそ）ぎの お知（し）らせ として 伝（つた）え ています。あとで、人（ひと）の 数（かず） が 一部（いちぶ） 変（か）わるかもしれません。",
