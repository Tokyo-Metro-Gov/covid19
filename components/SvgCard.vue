...
<i18n>
{
  ...
  "zh-cn": {
    ...
    "検査実施人数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "检查人数是快讯方式公开的数值，日后有可能变更"
  },
  "zh-tw": {
    "（注）都内において疑い例または患者の濃厚接触者として検査を行ったものについて掲載": "（註）列出與東京都疑似病例或是曾與患者密切接觸 ",
    "（チャーター機帰国者、クルーズ船乗客等は含まれていない）": "（包機返國者、郵輪乘客等除外）",
    "検査実施人数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "送檢人數為速報值，有可能在未來被確認過後的資料修正。"
  },
  "ko": {
    ...
    "検査実施人数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "검사실시인수는 속보치이며 차후 확정데이터로 수정될수있습니다"
  },
  "ja-basic": {
    ...
    "検査実施人数は、速報値として公開するものであり、後日確定データとして修正される場合があります": "検査（けんさ）した人（ひと）の数（かず）は、急（いそ）ぎの お知（し）らせ として 伝（つた）え ています。あとで、人（ひと）の 数（かず） が 一部（いちぶ） 変（か）わるかもしれません。"
  }
}
</i18n>
