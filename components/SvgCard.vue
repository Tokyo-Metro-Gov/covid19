...
<i18n>
{
  ...
  "ja-basic": {
    "（注）都内において疑い例または患者の濃厚接触者として検査を行ったものについて掲載": "（注意（ちゅうい）） 東京都（とうきょうと）の中（なか）で、コロナウイルスの 病気（びょうき）かもしれない人（ひと）、または コロナウイルスの 病気（びょうき）の 人（ひと）と とても 近（ちか）くに いた人（ひと）として、検査（けんさ）したもの を 伝（つた）えています。",
    "（チャーター機帰国者、クルーズ船乗客等は含まれていない）": "（チャーター の ひこうき、クルーズ の ふね に 乗（の）っていた 人（ひと）は 含（ふく）まれていません）"
  }
}
</i18n>
