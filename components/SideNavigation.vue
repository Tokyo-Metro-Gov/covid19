...
<i18n>
{
  ...
  "ja-basic": {
    "サイドメニュー項目を開く": "サイドメニュー項目（こうもく）を開（ひら）く",
    "サイドメニュー項目を閉じる": "サイドメニュー項目（こうもく）を閉（と）じる",
    "東京都": "東京都（とうきょうと）",
    "新型コロナウイルス感染症": "新（あたら）しい コロナウイルス の",
    "対策サイト": "病気（びょうき）対策（たいさく）サイト",
    "都内の最新感染動向": "東京都（とうきょうと）の中（なか）での 今（いま）の コロナウイルスの 病気（びょうき）の 様子（ようす）",
    "新型コロナウイルス感染症が心配なときに": "新（あたら）しい コロナウイルス が 心配（しんぱい）な とき に",
    "お子様をお持ちの皆様へ": "子供（こども） が いる みなさん へ",
    "都民の皆様へ": "東京都（とうきょうと） に 住（す）んで いる みなさん へ",
    "企業の皆様・はたらく皆様へ": "働（はたら）いている みなさん へ",
    "東京都新型コロナウイルス感染症対策本部報": "東京都（とうきょうと）から の 新（あたら）しい コロナウイルス についての お知（し）らせ",
    "東京都主催等 中止又は延期するイベント等": "【東京都（とうきょうと）主催（しゅさい）等（など）】止（や）めた または 他（ほか）の日（ひ）に 変（か）えた イベント・説明会（せつめいかい）等（など）",
    "東京都公式ホームページ": "東京都（とうきょうと）の 公式（こうしき）ホームページ",
    "知事からのメッセージ": "東京都（とうきょうと）知事（ちじ）から の 言葉（ことば）",
    "当サイトについて": "この ウェブサイト について",
    "このサイトの内容物は": "この ウェブサイトの 内容（ないよう）は",
    "クリエイティブ・コモンズ 表示 4.0 ライセンス": "クリエイティブ・コモンズ 表示 4.0 ライセンス",
    "の下に提供されています。": "で 提供（ていきょう）します"
  }
}
</i18n>
