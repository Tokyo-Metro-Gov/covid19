  ...
  <div ref="Side" class="SideNavigation" tabindex="-1">
    ...
    <div :class="['SideNavigation-Body', { '-opened': isNaviOpen }]">
      ...
      <nav class="SideNavigation-Menu">
        ...
        >
          <label class="SideNavigat ion-LanguageLabel" for="LanguageSelector">
            {{ $t('多言語対応選択メニュー') }}
          </label>
          <LanguageSelector />
        </div>
      ...
      <footer class="SideNavigation-Footer">
        <div class="SideNavigation-Social">
          <a
            href="https://line.me/R/ti/p/%40Hamamatsu"
            target="_blank"
          ...
          <a
            href="https://twitter.com/Hamamatsu_pr"
            target="_blank"
            rel="noopener noreferrer"
            class="SideNavigation-SocialLink"
          >
          ...
          <a
            href="https://www.facebook.com/hamamatsu.iira"
            target="_blank"
            rel="noopener noreferrer"
            class="SideNavigation-SocialLink"
          >
  ...
  computed: {
    items(): Item[] {
      return [
        ...
        {
          title: this.$t('浜松市公式ホームページ'),
          link: 'https://www.city.hamamatsu.shizuoka.jp/',
          divider: true
        },
        {
