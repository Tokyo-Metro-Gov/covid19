  ...
  <data-view :title="title" :date="date">
    <template v-slot:button>
      <p class="MetroGraph-Desc">
        {{
          $t('{range}の利用者数*の平均値を100としたときの相対値', {
            range: chartData.base_period
          })
        }}
        <br />
        *{{ $t('都営地下鉄4路線の自動改札出場数') }}
...
{
  "ja": {
    "{range}の利用者数*の平均値を100としたときの相対値": "{range}の利用者数*の平均値を100としたときの相対値",
    "都営地下鉄4路線の自動改札出場数": "都営地下鉄4路線の自動改札出場数"
  },
  "en": {
    "{range}の利用者数*の平均値を100としたときの相対値": "Congestion index compared to {range}.",
    "都営地下鉄4路線の自動改札出場数": "Total number of passengers using four Toei subway lines"
  },
  "zh-cn": {
    "{range}の利用者数*の平均値を100としたときの相対値": "{range}间乘客数*的平均值为 100 时的相对值",
    "都営地下鉄4路線の自動改札出場数": "都营地下铁 4 条路线的出站乘客数"
  },
  "zh-tw": {
    "{range}の利用者数*の平均値を100としたときの相対値": "{range}搭乘人數*平均值為 100 人為基準之相對數值",
    "都営地下鉄4路線の自動改札出場数": "都營地下鐵 4 條路線的出站人數"
  },
  "ko": {
    "{range}の利用者数*の平均値を100としたときの相対値": "1월 20일부터 24일까지의 이용자 수*의 평균값을 100으로 했을 때의 상대값",
    "都営地下鉄4路線の自動改札出場数": "도에이 전철 4개 노선을 이용한 승객 수"
  },
  "pt-BR": {
    "{range}の利用者数*の平均値を100としたときの相対値": "Valor indicador comparado ao valor da média do dia 20 a 24 de Janeiro",
    "都営地下鉄4路線の自動改札出場数": "Total de usuarios das 4 linhas de metro Toei"
  },
  "ja-basic": {
    "{range}の利用者数*の平均値を100としたときの相対値": "ひとの かずを くらべると",
