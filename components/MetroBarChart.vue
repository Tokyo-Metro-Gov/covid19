...
<i18n>
{
  ...
  "ja-basic": {
    "{range}の利用者数*の平均値を基準としたときの相対値": "{range} の 使（つか）った 人（ひと） の 数（かず）の 平均値（へいきんち） を もと に 比（くら）べた 数（かず）",
    "都営地下鉄4路線の自動改札出場数": "都営（とえい）地下鉄（ちかてつ）4路線（ろせん） の 駅（えき）自動改札（じどうかいさつ）から 出（で）た 人（ひと） の 数（かず）",
