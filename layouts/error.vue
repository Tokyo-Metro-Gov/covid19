...
<i18n>
{
  ...
  "ja-basic": {
    "このページはご利用いただけません": "このページは 使（つか）えません",
    "現在ご利用できません": "いま このページは 使（つか）えません",
    "アクセスしようとしたページが見つかりませんでした。": "この ページは ありませんでした",
    "ページが移動または削除されたか、URLの入力間違いの可能性があります。": "ページが 他（ほか）に 行（い）ったか、消（け）されたか、URLの入（い）れ 間違（まちが）いの 可能性（かのうせい）が あります。",
    "トップページへ戻る": "はじめの ページ に 戻（もど）る"
  }
}
</i18n>
