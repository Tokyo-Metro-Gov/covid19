<template>
  <v-app class="app">
    <v-overlay v-if="loading" color="#F8F9FA" opacity="1" z-index="9999">
      <div class="loader">
        <img src="/logo.svg" alt="沖縄県" />
        <scale-loader color="#DD3B33" />
      </div>
    </v-overlay>
  ...
  head(): MetaInfo {
    ...
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://okinawa.stopcovid19.jp/${this.$route.path}`
        },
        {
          rel: 'stylesheet',
      ...
      meta: [
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://okinawa.stopcovid19.jp${this.$route.path}`
        },
        ogLocale,
        {
          hid: 'og:title',
