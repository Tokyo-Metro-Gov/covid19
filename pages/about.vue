<template>
  <div class="About">
    ...
    <TextCard>
      ...
      {{
        $t(
          '鹿児島県による公式情報と客観的な数値をわかりやすく伝えることで、鹿児島県にお住まいの方や、鹿児島県内に拠点を持つ企業の方、鹿児島県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </TextCard>
    ...
    <TextCard :title="$t('免責事項')">
      {{
        $t(
          '当サイトに掲載されている情報の正確性については万全を期していますが、鹿児島県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
        )
      }}<br />
      <br />
      {{
