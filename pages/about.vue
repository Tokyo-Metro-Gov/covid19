<template>
  <div class="About">
    ...
    <TextCard title="ブラウザ環境について">
      本サイトは以下の環境でご覧いただくことを推奨いたします。<br />
      <br />
    ...
    <TextCard title="当Webサイトへのリンクについて">
      当Webサイトへのリンクは自由です。
    </TextCard>
    <TextCard title="JavaScriptについて">
      当WebサイトではJavaScriptを使用しております。<br />
    ...
    <TextCard title="クッキー (Cookie) について">
      当Webサイトの一部ではクッキーを使用しています。<br />
      クッキーとは、Webコンテンツからの要求で利用者の手元の端末に一時的に保存されるデータのことで、当Webサイトでは利用状況の把握のためにクッキーを使用する場合があります。<br />
      <br />
