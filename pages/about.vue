<template>
  <div class="About">
    ...
    <TextCard :title="$t('Google Analyticsの利用について')">
      ...
      {{
        $t(
          'Google Analyticsは、当サイトが発行するクッキー (Cookie) を利用して、Webサイトの利用データ（アクセス状況、トラフィック、閲覧環境、およびIPアドレスをはじめとする個人を特定可能な一部の情報）を収集しております。クッキー (Cookie) の利用に関してはGoogleのプライバシーポリシーと規約に基づいております。'
        )
      }}<br />
      {{
        $t(
