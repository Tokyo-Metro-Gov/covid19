  ...
  data() {
    return {
      items: [
        {
          title: '',
          body: `当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、東京都が開設したものです。
            <br />
            <br />
        ...
        {
          title: 'ブラウザ環境について',
          body: `当サイトは以下の環境でご覧いただくことを推奨いたします。<br />
            <br />
        ...
        },
        {
          ...
          body: `当サイトではJavaScriptを使用しております。<br />
        ...
        {
          title: 'GoogleAnalytics の利用について',
          body: `当サイトでは、サービス向上やWebサイトの改善のためにGoogle Inc.の提供するアクセス分析のツールであるGoogle Analyticsを利用した計測を行っております。<br />
        ...
        {
          title: '免責事項',
          body: `当サイトに掲載されている情報の正確性については万全を期していますが、東京都は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
            <br />
        ...
        {
          title: 'データについて',
          body: `当サイトで公表しているデータは、東京都オープンデータサイト(準備中)より誰でも自由にダウンロードが可能です。`
        },
        {
          title: 'お問い合わせ先（都のHPサイトポリシーについて）',
          body: ` 東京都生活文化局広報広聴部広報課<br />
            電話
