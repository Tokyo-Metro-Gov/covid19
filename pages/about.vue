<template>
  <div class="About">
    ...
    <StaticCard>
      ...
      {{
        $t(
          '沖縄県と連携し、県による公式情報と客観的な数値をわかりやすく伝えることで、沖縄県にお住まいの方や、沖縄県に拠点を持つ企業の方、沖縄県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
      <br /><br />
      {{
        $t(
          '開発は、複製・改変が許されたオープンソースライセンスで公開されている、東京都公式コロナウイルス対策サイトの仕組みを利用しています。'
        )
      }}
    </StaticCard>
    <StaticCard>
