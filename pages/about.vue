<template>
  <div class="About">
    ...
    <static-card>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、北九州市と市内企業の有志が開設したものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          '北九州市による公式情報と客観的な数値をわかりやすく伝えることで、北九州市にお住まいの方や、北九州市内に拠点を持つ企業の方、北九州市を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </static-card>
    <static-card>
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、北九州市は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
    ...
    <static-card>
      ...
      >
        <template v-slot:catalogWebsite>
          <external-link
            url="https://www.open-governmentdata.org/kitakyushu-city/"
            :icon-size="16"
          >
            {{ $t('北九州市オープンデータサイト') }}
          </external-link>
