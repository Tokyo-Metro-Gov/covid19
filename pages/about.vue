<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、兵庫県に住むクリエイターの有志が開設したサイトです。公式情報ではないことをご了承下さい。<br />
      <br />
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報の正確性については万全を期していますが、兵庫県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
