...
<i18n>
{
  ...
  "ja-basic": {
    "都内の最新感染動向": "東京都（とうきょうと）の中（なか）での 今（いま）の コロナウイルスの 病気（びょうき）の 様子（ようす）",
    "自分や家族の症状に不安や心配があればまずは電話相談をどうぞ": "あなた や 家族（かぞく）の 体（からだ）の 具合（ぐあい）が 悪（わる）くて 不安（ふあん）や心配（しんぱい）が あれば 電話（でんわ）相談（そうだん）して ください",
    "相談の手順を見る": "相談（そうだん）の ながれ を 見（み）る",
    "検査陽性者の状況": "検査（けんさ）して、コロナウイルス の 病気（びょうき）と わかった 人（ひと）の 状況（じょうきょう）",
    "陽性患者数": "コロナウイルスの 病気（びょうき）の 人（ひと）の 数（かず）",
    "陽性患者の属性": "コロナウイルスの 病気（びょうき）の 人（ひと）の 属性（ぞくせい）",
    "検査実施数": "検査（けんさ）した 数（かず）",
    "新型コロナコールセンター相談件数": "新（あたら）しい コロナコールセンターへの 電話（でんわ）相談（そうだん）の 数（かず）",
    "新型コロナ受診相談窓口相談件数": "新（あたら）しい コロナウイルスの 病気（びょうき）のことで 相談（そうだん）した 人（ひと）の 数（かず）",
    "都営地下鉄の利用者数の推移": "都営（とえい）地下鉄（ちかてつ）を 使（つか）った人（ひと）の 数（かず）",
    "都内発生（疑い例・接触者調査）": "都内発生（とないはっせい）（疑い例・接触者調査（うたがいれい せっしょくしゃちょうさ））<br>※東京都（とうきょうと）の中（なか）で コロナウイルス の 病気（びょうき）と わかった人（ひと）（コロナウイルスの 病気（びょうき）かもしれない人（ひと）、病気の人（ひと）と 会った人（ひと）について 調（しら）べた ことを 含（ふく）みます）",
    "その他（チャーター便・クルーズ便）": "その他（ほか）（チャーター の ひこうき、クルーズ の ふね）",
    "{date}の累計": "{date} まで 全部（ぜんぶ）で",
    "期間: {duration}": "期間（きかん）: {duration}",
    "{duration}の利用者数との相対値: {percentage}": "{duration} に 使（つか）った 人（ひと）と 比（くら）べた 数（かず）",
    "1月20日~1月24日": "1月（がつ）20日（にち）から 1月（がつ）24日（にち）",
    "2月10日~14日": "2月（がつ）10日（にち）から 2月（がつ）14日（にち）",
    "2月17日~21日": "2月（がつ）17日（にち）から 2月（がつ）21日（にち）",
    "2月25日~28日": "2月（がつ）25日（にち）から 2月（がつ）28日（にち）",
    "人": "にん",
    "件": {
      "tested": "けん",
      "reports": "けん"
    ...
    "居住地": "住（す）んでいる ところ",
    "年代": "年代（ねんだい）",
    "性別": "性別（せいべつ）(男（おとこ）・女（おんな））",
    "都内": "東京都（とうきょうと）の 中（なか）",
    "埼玉県": "埼玉県（さいたまけん）",
    "湖南省長沙市": "中国（ちゅうごく）湖南省（こなんしょう）長沙市（ちょうさし）",
    "湖北省武漢市": "中国（ちゅうごく）湖北省（こほくしょう）武漢市（ぶかんし）",
    "{age}代": "{age}代（だい）",
    "10歳未満": "10歳（さい）未満（みまん）：0歳から 9歳までの人（ひと）",
    "男性": "男（おとこ）の 人（ひと）",
    "女性": "女（おんな）の 人（ひと）",
    "退院※": "退院（たいいん）※"
  }
