  ...
  <div class="Worker">
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '都内中小企業が感染症対策関連商品の製造等に必要となる機械設備を新たに導入する経費を助成します（助成限度額：1億円 ／ 助成率：5分の4）。'
          )
        }}
      </p>
    </static-card>
...
"
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '新型コロナウイルスの影響を受けた求職者又は非正規雇用者、フリーランスの方等を対象として、知識・技能のスキルアップを図るため、eラーニングによる委託訓練を新たに実施します(募集開始5月下旬）'
          )
        }}
      </p>
    </static-card>
