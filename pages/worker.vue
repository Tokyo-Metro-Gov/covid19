...
export default Vue.extend({
  ...
  data: (): ItemData => ({
    items: [
      ...
      {
        title: 'テレワークオンラインセミナー開催',
        link: 'https://tokyo-telework.jp/',
        body:
      ...
      },
      {
        ...
        body: '資金繰りに関する相談、経営に関する相談'
      },
      {
        title: 'フリーランスを含む個人事業主特別相談窓口',
        link:
          'http://www.sangyo-rodo.metro.tokyo.jp/attention/2020/0305_13201.html',
        body: '資金繰りに関する相談、経営に関する相談（契約におけるトラブル等）'
      },
      {
        title: '緊急労働相談ダイヤル',
        link: 'https://www.hataraku.metro.tokyo.lg.jp/sodan/sodan/index.html',
        body:
