    ...
    return {
      items: [
        ...
        },
        {
          ...
          body:
            '兵庫県内中堅・中小企業に対し、テレワークの導入に必要な機器やソフトウェア等の経費を助成します（限度額250万円、助成率10/10）。ぜひご活用ください。'
        },
        {
          title: '中小企業者等特別相談窓口',
          link:
          ...
          body:
            '資金繰りに関する相談、経営に関する相談（兵庫県産業労働局　報道発表）'
        },
        {
          title: '緊急労働相談ダイヤル',
          link:
          ...
          body:
            '新型コロナウイルスに関する休暇や休業の取り扱い、職場のハラスメントなどについての相談（兵庫県産業労働局　報道発表）'
        },
        {
