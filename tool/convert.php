...
{
  $data = xlsxToArray(__DIR__.'/downloads/兵庫県患者発生発表数-RAW.xlsx', 'RAW', 'A2:J100', 'A1:J1');
  ...
  return [
    'date' => xlsxToArray(__DIR__.'/downloads/兵庫県患者発生発表数-RAW.xlsx', 'RAW', 'M1')[0][0],
    'data' => [
...
function readInspectionsSummary(array $inspections) : array
{
  return [
    ...
    'data' => [
      '兵庫県内' => $inspections['data']->map(function ($row) {
