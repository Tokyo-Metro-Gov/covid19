...
and then the production site (https://stopcovid19-hamamatsu.netlify.com/) will be also updated.
...
and then the development site (https://dev-stopcovid19-hamamatsu.netlify.com/) will be also updated.
