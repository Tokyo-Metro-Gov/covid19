...
export interface Data {
    ...
    the6入院患者数:                        number;
    the6入院患者確保病床数:                    string;
    the7重症患者数:                        number;
    the7重症患者確保病床数:                    string;
    総括コメント感染状況:                       総括コメント;
    総括コメント医療提供体制:                     総括コメント;
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "(4)PCR・抗原検査（検査人数）", js: "the4Pcr抗原検査検査人数", typ: 0 },
        { json: "(5)救急医療の東京ルールの適用件数", js: "the5救急医療の東京ルールの適用件数", typ: 3.14 },
        { json: "(6)入院患者数", js: "the6入院患者数", typ: 0 },
        { json: "(6)入院患者確保病床数", js: "the6入院患者確保病床数", typ: "" },
        { json: "(7)重症患者数", js: "the7重症患者数", typ: 0 },
        { json: "(7)重症患者確保病床数", js: "the7重症患者確保病床数", typ: "" },
