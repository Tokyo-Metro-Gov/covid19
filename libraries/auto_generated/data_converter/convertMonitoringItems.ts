...
export interface Data {
    ...
    the3Pcr抗原検査陽性率:                   number;
    the3Pcr抗原検査検査人数:                  number;
    the4救急医療の東京ルールの適用件数:              number;
    the5入院患者数:                        number;
    the5入院患者確保病床数:                    number;
    the6重症患者数:                        number;
    the6重症患者確保病床数:                    number;
    総括コメント感染状況:                       総括コメント;
    総括コメント医療提供体制:                     総括コメント;
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        // (1) - (4) は7日間移動平均につき小数になることがある．
        // したがってこれらについては typ: 3.14 とすること．
        { json: "(1)新規陽性者数", js: "the1新規陽性者数", typ: 3.14 },
        { json: "(2)#7119（東京消防庁救急相談センター）における発熱等相談件数 ", js: "the27119東京消防庁救急相談センターにおける発熱等相談件数", typ: 3.14 },
        { json: "(3)PCR・抗原検査（陽性率）", js: "the3Pcr抗原検査陽性率", typ: 3.14 },
        { json: "(3)PCR・抗原検査（検査人数）", js: "the3Pcr抗原検査検査人数", typ: 3.14 },
        { json: "(4)救急医療の東京ルールの適用件数", js: "the4救急医療の東京ルールの適用件数", typ: 3.14 },
        { json: "(5)入院患者数", js: "the5入院患者数", typ: 0 },
        { json: "(5)入院患者確保病床数", js: "the5入院患者確保病床数", typ: 0 },
        { json: "(6)重症患者数", js: "the6重症患者数", typ: 0 },
        { json: "(6)重症患者確保病床数", js: "the6重症患者確保病床数", typ: 0 },
