// To parse this data:
//
//   import { Convert, VaccinationCount } from "./file";
//
//   const vaccinationCount = Convert.toVaccinationCount(json);
//
...
export class Convert {
    public static toVaccinationCount(json: string): VaccinationCount {
        return cast(JSON.parse(json), r("VaccinationCount"));
    }

    public static vaccinationCountToJson(value: VaccinationCount): string {
        return JSON.stringify(uncast(value, r("VaccinationCount")), null, 2);
    }
}
